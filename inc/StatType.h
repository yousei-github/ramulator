...
#if (USER_CODES == ENABLE)
    stat_output << "read_latency_sum: " << read_latency_sum << std::endl;
    stat_output << "write_latency_sum: " << write_latency_sum << std::endl;
    stat_output << "read_requests: " << read_requests << std::endl;
...
#if (USER_CODES == ENABLE)
  void update_read_latency_sum(double value)
  {
    read_latency_sum += value;
  }
  void update_write_latency_sum(double value)
  {
    write_latency_sum += value;
  }void update_read_requests(double value)
  {
    read_requests += value;
  }void update_write_requests(double value)
  {
